...
{
    private readonly string lCadenaCnx;

    public AWContext(string pCadenaCnx)
    {
        lCadenaCnx = pCadenaCnx;
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=sj10123-735542; Database=AdventureWorks2022; Trusted_Connection=True; TrustServerCertificate=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<CountryRegion>(entity =>
        {
            ...
            entity.ToTable("CountryRegion", "Person", tb =>
                {
                    tb.HasComment("Lookup table containing the ISO standard codes for countries and regions.");
                    tb.HasTrigger("TRG_COUNTRYREGION_FORDELETE");
                    tb.HasTrigger("TRG_COUNTRYREGION_FORINSERT");
                    tb.HasTrigger("TRG_COUNTRYREGION_FORUPDATE");
                    tb.HasTrigger("TRG_COUNTRYREGION_TRANSACCIONES");
                    tb.HasTrigger("TRG_COUNTRYREGION_TRANSACCIONES_V1");
                });
